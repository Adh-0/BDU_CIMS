...
- Initial version of the project import
- Initial concept for a university information assistant
- Early prototype built around admissions and academic queries
- Established the project direction for a document-based support system
